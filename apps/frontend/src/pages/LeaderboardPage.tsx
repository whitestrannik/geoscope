    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-purple-900">
      ...
      <div className="max-w-6xl mx-auto p-6 space-y-6 relative z-10">
        ...
        {activeTab === 'global' && !globalLoading && (
          <Card className="bg-black/80 backdrop-blur-md border-cyan-500/30 shadow-2xl shadow-cyan-500/10">
            <CardHeader>
                ...
                <div className="space-y-2">
                  {recentWinners.map((winner, index) => (
                    <div
                      ...
                      className="flex items-center justify-between p-4 rounded-lg border bg-gray-900/60 hover:bg-gray-800/80 border-cyan-500/20 hover:border-cyan-400/40 transition-all duration-300 hover:scale-[1.02]"
                    >
                      <div className="flex items-center gap-4">
                        <div className="flex items-center justify-center w-12 h-12 bg-black/50 rounded-lg border border-cyan-500/30">
                          {index < 3 ? (
        ...
        {globalTop && globalTop.length > 0 && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <Card className="bg-black/80 backdrop-blur-md border-blue-500/30 shadow-lg shadow-blue-500/10">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium font-mono text-blue-400">ACTIVE OPERATIVES</CardTitle>
        ...
        {/* Call to Action */}
        <Card className="bg-gradient-to-r from-purple-900/80 to-blue-900/80 backdrop-blur-md border-purple-500/30 shadow-2xl shadow-purple-500/20">
